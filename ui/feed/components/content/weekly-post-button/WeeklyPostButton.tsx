...
export default function WeeklyPostCTA() {
  const handlePost = () => {
    toast.info("Recommendation composer coming soon.", {
      description: "This is where you would add a new pick for the week.",
    });
  };
  ...
  return (
    ...
    >
      <Stack gap={0} className="p-5">
        ...
        <Button onClick={handlePost} className="w-full gap-2 py-3">
          <Plus size={16} />
